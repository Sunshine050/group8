...
class LectureHistory extends StatefulWidget {
  ...
  @override
  LectureHistoryState createState() => LectureHistoryState();
}

class LectureHistoryState extends State<LectureHistory> {
  ...
  void _showRoomDetails(BuildContext context, String status) {
    Color statusColor;
    String statusText;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lecture History', style: TextStyle(color: Colors.black)),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () => _showRoomDetails(context, status),
            child: RoomCard(
              roomName: roomName,
              roomSize: 'Room size :',
