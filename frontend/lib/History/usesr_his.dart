...
class _HistoryPageState extends State<HistoryPage> {
  int _selectedIndex = 3; // Default index to 'History' page

  void _onItemTapped(int index) {
    setState(() {
      _selectedIndex = index;
      // Navigation for other pages can be added here based on index
    });
  }
  ...
  void _showRoomDetails(BuildContext context, String status, String approver) {
    ...
    if (status == 'Approved') {
      ...
      statusColor = Colors.amber; // Yellow color for Pending
      statusText = "Pending";
    }
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image.network(
                    'https://www.appliedglobal.com/wp-content/uploads/How-to-Create-a-Modern-Meeting-Room-Setup-2048x1152.png', // Replace with actual room image URL
  ...
  Widget build(BuildContext context) {
    ...
    List<String> statuses = ['Approved', 'Disapproved', 'Pending'];
